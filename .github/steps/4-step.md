...
1. Open the **Copilot Chat** panel and switch to **Plan Agent**.
   ...
   <img width="350" alt="image" src="https://github.com/BettaJhan/skillss-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. Review the proposed plan and when you are happy with it, click **Start implementation** to hand off to **Agent Mode**.
   ...
   <img width="350" alt="image" src="https://github.com/BettaJhan/skillss-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
